...
public class PunishmentsListCMD extends CommandBase {
    ...
    public PunishmentsListCMD() {
        super("list", "List all punishments for a player");
    ...
    protected void executeSync(@NotNull CommandContext ctx) {
        ...
        fp.sendMessage("Punishments for " + target.getData().getUsername() + ":");

...
public class BanCMD extends CommandBase {
    ...
    protected final RequiredArg<FancyPlayer> targetArg = this.withRequiredArg("target", "The player to ban",
            FancyCoreArgs.PLAYER);
    protected final RequiredArg<List<String>> reasonArg = this.withListRequiredArg("reason", "The reason for the ban",
            ArgTypes.STRING);
    ...
    protected void executeSync(@NotNull CommandContext ctx) {
        ...
        translator.getMessage("moderation.ban.permanent.success", fp.getLanguage())
